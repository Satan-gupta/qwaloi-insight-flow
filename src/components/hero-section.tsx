  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20">
      ...
      <div className="container section-padding flex flex-col items-center text-center">
        ...
        <div className="mt-16 w-full max-w-5xl animate-fade-in animate-delay-300">
          <div className="relative w-full aspect-video bg-gradient-to-br from-gray-100 to-white dark:from-gray-800 dark:to-gray-900 rounded-xl overflow-hidden shadow-xl border border-gray-200 dark:border-gray-700">
            <div className="absolute inset-0 flex items-center justify-center">
              <svg className="h-24 w-24 text-gray-400 dark:text-gray-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
