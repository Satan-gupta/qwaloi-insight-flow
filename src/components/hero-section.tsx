...
export function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-center pt-20 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/3 h-full -z-10 opacity-20 dark:opacity-10">
      ...
      <div className="container max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="mt-20 lg:mt-0 order-2 lg:order-1">
            ...
            <h1 className="text-4xl md:text-6xl xl:text-7xl font-bold leading-tight mb-6 animate-slide-up stagger-2">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-xl animate-slide-up stagger-3">
          ...
          <div className="order-1 lg:order-2">
            <div className="relative w-full aspect-square md:aspect-[4/3] rounded-xl overflow-hidden shadow-xl border border-gray-200 dark:border-gray-700 animate-slide-up stagger-3">
